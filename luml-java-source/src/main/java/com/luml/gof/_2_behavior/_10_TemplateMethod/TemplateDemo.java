package com.luml.gof._2_behavior._10_TemplateMethod;
 ...
 *         leave();
 *     }
 *     private void takeNumber() { System.out.println("取号"); }
 *     private void queue() { System.out.println("排队"); }
 *     protected abstract void handleBusiness(); // 子类实现
 *     private void leave() { System.out.println("离开银行"); }
 * }
 * 子类通过实现handleBusiness()完成存款、转账等具体业务。
 */
//1、模版方法接口
