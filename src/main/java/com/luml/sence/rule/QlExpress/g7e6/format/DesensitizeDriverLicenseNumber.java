...
public class DesensitizeDriverLicenseNumber extends DesensitizeOperator {

    public static final String OPERATOR_NAME = "脱敏驾驶证档案编号";

    @Override
    public String desensitize(String data) {
        return MaskingTool.mask(data, MaskingType.DRIVER_LICENSE_NUMBER);
    }
}
