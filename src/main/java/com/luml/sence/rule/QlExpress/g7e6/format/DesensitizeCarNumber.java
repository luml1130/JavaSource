...
public class DesensitizeCarNumber extends DesensitizeOperator{

    public static final String OPERATOR_NAME = "脱敏车牌号";

    @Override
    public String desensitize(String data) {
        return MaskingTool.mask(data, MaskingType.CAR_NUMBER);
    }
}
