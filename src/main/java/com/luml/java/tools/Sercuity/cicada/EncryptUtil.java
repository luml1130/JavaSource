 ...
 * 功能描述
 * 加密常用类
 * eduplus-uc zl-qrcode
 */
public class EncryptUtil {
    //  byte[] kk = {'i','m','z','h','i','l','i','a','o','.','c','o','m','1','2','3'};
    // 密钥是16位长度的byte[]进行Base64转换后得到的字符串
    public static String key = "aW16aGlsaWFvLmNvbTEyMw==";
    ...
    public static String encrypt(String xmlStr) {
        ...
        return null;//BaseEncoding.base64Url().encode(temp);
